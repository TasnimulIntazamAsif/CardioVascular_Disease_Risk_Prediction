#!/usr/bin/env python3
"""
Train Random Forest model with weighted feature fusion for CVD Risk Assessment
...
def train_randomforest_fusion_model():
    ...
    joblib.dump(model, 'models/rf_fusion_best_model.joblib')
    ...
    print("Random Forest Fusion model training completed successfully!")
...
if __name__ == "__main__":
    print("=" * 80)
    print("RANDOM FOREST FUSION MODEL TRAINING")
    print("=" * 80)
    
    model, scaler_clinical, scaler_lifestyle, label_encoders = train_randomforest_fusion_model()
    
    print("\n" + "=" * 80)
    print("TRAINING COMPLETED")
    print("=" * 80)
    print("Model saved to: models/rf_fusion_best_model.joblib")
