...
async function handleFormSubmission(event) {
    ...
    // Set a timeout to force hide modal if it gets stuck (30 seconds)
    const modalTimeout = setTimeout(() => {
        console.log('Modal timeout reached, forcing hide');
        forceHideModal();
    }, 30000);
    ...
    try {
        ...
        // Hide loading modal with proper cleanup
        loadingModal.hide();
        
        // Ensure modal is completely hidden with backup
        setTimeout(() => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Add event listener to ensure modal cleanup
    const loadingModalElement = document.getElementById('loadingModal');
